...
public class MapperStudentRS {
	...
	public static List<CourseEnrollment> mapResultSetToCourseEnrollments(ResultSet rs, Connection conn)
			throws SQLException {
	...
	private static Student mapStudentFromRs(ResultSet rs, Connection conn) throws SQLException {
		Student temp = new Student(rs.getLong("user_id"), rs.getString("username"), rs.getString("password"),
				rs.getString("first_name"), rs.getString("last_name"), rs.getDate("birthdate").toLocalDate(),
	...
	private static List<CourseEnrollment> mapFullyCourseEnrollmentsByStudent(ResultSet rs, Connection conn)
			throws SQLException {
		List<CourseEnrollment> courseEnrollments = new ArrayList<>();
